...
def max_distance(current_location, total_distance, remaining_locations):
    if remaining_locations == []:
        ...
        for location in remaining_locations:
            ...
            max_list.append(max_distance(location, new_total_distance, new_remaining_locations))
        return(max(max_list))
...
for starting_location in all_locations:
    ...
    all_max_distances.append(max_distance(starting_location, 0, all_locations_starting))
    
print(max(all_max_distances))
